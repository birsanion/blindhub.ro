                ...
                <div class="offset-lg-2 col-lg-8">
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                            <div class="member shadow">
                                <div class="member-img">
                                    <img src="<?= qurl_f('images/foto_dacianpribeanu.jpg') ?>" class="img-fluid" alt="">
                                </div>
                                <div class="member-info">
                        ...
                        <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                            <div class="member shadow">
                                <div class="member-img">
                                    <img src="<?= qurl_f('images/foto_ioanaseremet.jpg') ?>" class="img-fluid w-100" alt="">
                                </div>
                                <div class="member-info">
                                    <h4>Ioana Sereme</h4>
                                    <span>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                            <div class="member shadow">
                                <div class="member-img">
                                    <img src="<?= qurl_f('images/foto_anacorello.jpg') ?>" class="img-fluid w-100" alt="">
                                </div>
                                <div class="member-info">
                                    <h4>Ana Corello</h4>
                                    <span>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                            <div class="member shadow">
                                <div class="member-img">
                                    <img src="<?= qurl_f('images/foto_oanatomescu.jpg') ?>" class="img-fluid w-100" alt="">
                                </div>
                                <div class="member-info">
                                    <h4>Oana Tomescu</h4>
                                    <span>
