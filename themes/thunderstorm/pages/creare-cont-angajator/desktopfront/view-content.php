                ...
                <table class="w80lst center-page">
                    <tr>
                        <td style="text-align: left;">
                            <label><input type="checkbox" name="hCheck_Domenii_IT" value="it" /> IT </label>
                        </td>
                        <td style="text-align: left;">
                            <label><input type="checkbox" name="hCheck_Domenii_Medical" value="medical" /> Medical </label>
                        </td>
                    </tr>
                    
                    <tr>
                        <td style="text-align: left;">
                            <label><input type="checkbox" name="hCheck_Domenii_CallCenter" value="callcenter" /> Call center </label>
                        </td>
                        <td style="text-align: left;">
                            <label><input type="checkbox" name="hCheck_Domenii_ResurseUmane" value="resurseumane" /> Resurse umane </label>
                        </td>
                    </tr>
                    
                    <tr>
                        <td style="text-align: left;">
                            <label><input type="checkbox" name="hCheck_Domenii_AsistentaSociala" value="asistentasociala" /> Asistență socială </label>
                        </td>
                        <td style="text-align: left;">
                            <label><input type="checkbox" name="hCheck_Domenii_CustomerService" value="customerservice" /> Customer service (serviciu clienți) </label>
                        </td>
                    </tr>
                    
                    <tr>
                        <td style="text-align: left;">
                            <label><input type="checkbox" name="hCheck_Domenii_Jurnalism" value="jurpr" /> Jurnalism &amp; relații publice </label>
                        </td>
                        <td style="text-align: left;">
                            <label><input type="checkbox" name="hCheck_Domenii_Radio" value="radio" /> Radio </label>
                        </td>
                    </tr>
                    
                    <tr>
                        <td style="text-align: left;">
                            <label><input type="checkbox" name="hCheck_Domenii_Psihologie" value="psiho" /> Psihologie / consiliere / coaching </label>
                        </td>
                        <td style="text-align: left;">
                            <label><input type="checkbox" name="hCheck_Domenii_Educatie" value="educatie" /> Educație și training </label>
                        </td>
                    </tr>
                    
                    <tr>
                        <td style="text-align: left;">
                            <label><input type="checkbox" name="hCheck_Domenii_Artistica" value="artistica" /> Industria creativă și artistică </label>
                        </td>
                        <td style="text-align: left;">
                            <label><input type="checkbox" name="hCheck_Domenii_AdminPub" value="adminpub" /> Administrație publică și instituții </label>
                        </td>
                    </tr>
                    
                    <tr>
                        <td style="text-align: left;">
                            <label><input type="checkbox" name="hCheck_Domenii_DeskOffice" value="deskoffice" /> Desk office </label>
                        </td>
                        <td style="text-align: left;">
                            <label><input type="checkbox" name="hCheck_Domenii_Wellness" value="wellness" /> Wellness &amp; Spa </label>
                        </td>
                    </tr>
                    
                    <tr>
                        <td style="text-align: left;">
                            <label><input type="checkbox" name="hCheck_Domenii_Traducator" value="traducator" /> Traducător / translator </label>
                        </td>
                        <td style="text-align: left;">
                            <label><input type="checkbox" name="hCheck_Domenii_Diverse" value="diverse" /> Diverse </label>
                        </td>
                    </tr>
                </table>
            </div>
