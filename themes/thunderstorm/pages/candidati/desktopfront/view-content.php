                    ...
                    <div class="body">
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-8 col-12">
                                ...
                                <p class="m-0">Grad de handicap: <?= $arrLoc['gradhandicap'] ?></p>
                                <p class="m-0">Nevoie speciale: <?= $arrLoc['nevoispecifice'] ?></p>
                                <div class="mt-3">
            ...
            <table id="tbl-rezultate-angajati" class="fullwidth">
                ...
                <tr>
                    <td style="width: 50%; padding: 5px;">
                        ...
                        <?php echo 'Candidează în următoarele posturi: ' . $arrLoc['slujbe']; ?><br />
                        <br /><br />
                        În data de
