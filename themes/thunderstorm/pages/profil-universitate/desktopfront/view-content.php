                            ...
                            <div class="d-flex flex-column align-items-center text-center">
                                ...
                                <div class="row">
                                    <div class="offset-md-2 col-md-8 col-sm-12 mb-3">
                                        <a type="button" class="btn btn-link" href="<?= qurl_l('universitate-logo') ?>">Shimbare logo</a>
                                    </div>
                                    <div class="offset-md-2 col-md-8 col-sm-12 mb-3">
                ...
                <div class="col-md-8">
                    <div class="card shadow mb-3">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                  <a class="btn btn-primary rounded-pill" href="<?= qurl_l('editeaza-profil-universitate') ?>"><strong>Editare cont</strong></a>
                                </div>
                            </div>
                        </div>
                    </div>
