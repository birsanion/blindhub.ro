<div id="content" class="container my-5">
        <div class="row">
            <div class="offset-lg-1 col-lg-10">
                <h1 class="titlu mb-5">Candidați favoriți</h1>
                <?php if (!count($this->DATA['locuri'])): ?>
                <h4><strong>Nu am găsit candidați</strong></h4>
                <p>Nu am găsit candidați pentru anunțurile postate</p>
                <?php endif; ?>
                <?php
                ...
                <div class="card shadow-lg mb-4">
                    ...
                    <div class="card-footer">
                        <a class="btn btn-primary rounded-pill px-3 mb-2" href="<?= qurl_l('mesaje/' . $arrLoc['idxauth']) ?>">Trimite mesaj</a>
                        <a class="btn btn-info rounded-pill px-3 mb-2" href="<?= qurl_l('cv-video/' . $arrLoc['idxauth']) ?>">Vizioneză CV-ul video</a>
                        <?php if (!$arrLoc['interviu_tstamp']): ?>
                        <button class="btn btn-warning rounded-pill btn-interviu px-3 mb-2" data-idxauth="<?= $arrLoc['idxauth'] ?>">Planifică interviu</button>
                        <?php endif; ?>
                    </div>
                </div>
                <?php
                            ...
                            callback: function () {
                                ...
                                $.ajax({
                                    ...
                                    bootbox.alert({
                                        ...
                                        callback: function() {
                                            window.location = '<?= qurl_l('candidati-favoriti'); ?>';
                                        }
                                    })
                                }).fail(function (e) {
