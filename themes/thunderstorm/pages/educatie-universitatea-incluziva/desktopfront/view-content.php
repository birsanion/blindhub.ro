    ...
    <div class="container my-5">
        <div class="row">
            <div class="offset-lg-1 col-lg-10">
                    <h1 class="titlu">Universitatea incluziva</h1>

                <article>
                    <p><strong>Scopul universitatii incluzive</strong>: dezvoltarea unei comunitati academice diverse prin sustinerea participarii persoanelor cu dizabilitati la un mediu educational accesibilizat si adaptat care sa permita valorificarea pe deplin a oportunitatilor si serviciilor educationale de excelenta furnizate de universitate.</p>
                    <p></p>
                    <p class="mt-5 subtitlu">Obiective:</p>
                    ...
                    <ul class="lista">
                        ...
                        <li>
                            ...
                            <p>Acest element  urmareste diversificarea activitatilor de sprijin destinate studentilor cu dizabilitati prin infiintarea unui centru de incluziune care sa asigure interfata cu studentii cu dizabilitati si potentiali studenti. De asemenea, se urmareste asigurarea conformitatii activitatilor universitatii la cerintele legale in ceea ce priveste comunicarea cu studentii cu dizabilitati, in special asigurarea drepturilor aplicabile in mediul educational. Universitatea se va asigura de promovarea drepturilor persoanelor cu dizabilitati in comunicari, evenimente si va adopta, dupa caz, mijloace alternative de comunicare. </p>
                        </li>
                        <li>
                            ...
                            <p>Universitatea va incuraja  mobilitatea internationala a studentilor cu dizabilitati, implicarea in activitatile de cercetare, precum si accesarea unor programe de invatamânt echivalente masteratului si doctoratului. De asemenea, obiectivul urmareste incurajarea participarii studentilor in asociatiile studentesti, proiecte de voluntariat si activitatile cultural-sportive (tabere studentesti).</p>
                        </li>
                        <li>
                            ...
                            <p>Obiectivul tinteste  dezvoltarea parteneriatelor cu asociatiile persoanelor cu dizabilitati, identificarea de proiecte comune care sa duca la cresterea numarului de studenti cu dizabilitati din mediul universitar, identificarea unor oportunitati de internship care sa faciliteze tranzitia studentilor spre piata muncii.</p>
                        </li>
                        <li>
                    ...
                    <br />
                    <p>Detinerea de cunostinte si competente in ceea ce priveste problematica dizabilitatii reprezinta elemente cheie in schimbarea culturii institutionale si in furnizarea unor servicii educationale de calitate. Astfel, acest obiectiv urmareste stabilirea unor programe de formare destinate personalului didactic si didactic auxiliar de la nivelul universitatii pe problematica dizabilitatii si incluziunii in mediul educational a persoanelor cu dizabilitati.</p>
                </article>
            </div>
        </div>
    </div>
